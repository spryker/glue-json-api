...
use Spryker\Glue\GlueApplicationExtension\Dependency\Plugin\ApiApplicationFlowPluginInterface;
 ...
 *
 */
abstract class AbstractGlueJsonApiApplicationPlugin extends AbstractPlugin implements ApiApplicationFlowPluginInterface
{
    /**
     * @return void
     */
